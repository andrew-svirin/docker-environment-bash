...
# Launch by command `wget https://github.com/andrew-svirin/docker-environment-bash/blob/master/setup.sh | /usr/sbin/sudo bash` 
# or by this short link `wget http://tiny.cc/uz7hdz | /usr/sbin/sudo bash`
echo "Setup runs ..."
